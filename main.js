// elm-watch hot {"version":"1.2.6","targetName":"index","webSocketPort":13990,"webSocketToken":"6388c8e8-250d-4d41-97f4-5c0f2e7cfd1b"}
"use strict";
(() => {
...
${indent.repeat(level)}}`;
  ...
  var VERSION = "1.2.6";
  var WEBSOCKET_TOKEN = "6388c8e8-250d-4d41-97f4-5c0f2e7cfd1b";
  var TARGET_NAME = "index";
  var INITIAL_ELM_COMPILED_TIMESTAMP = Number(
    "1776479077240"
  );
  var ORIGINAL_COMPILATION_MODE = "standard";
  var ORIGINAL_BROWSER_UI_POSITION = "BottomLeft";
  var WEBSOCKET_PORT = "13990";
...
var $author$project$Main$initialModel = {
	invoices: _List_fromArray(
		[
			{amount: 150.5, client: 'Juan Perez', id: 1},
			{amount: 200.0, client: 'Maria Garcia', id: 2},
			{amount: 75.25, client: 'Pedro Lopez', id: 3}
		])
};
...
var $author$project$Main$viewInvoice = function (invoice) {
	return A2(
		$elm$html$Html$li,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(invoice.client)
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						'Monto: $' + $elm$core$String$fromFloat(invoice.amount))
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						'ID: ' + $elm$core$String$fromInt(invoice.id))
					]))
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Mis Facturas')
					])),
				A2(
				$elm$html$Html$ul,
				_List_Nil,
				A2($elm$core$List$map, $author$project$Main$viewInvoice, model.invoices))
			]));
};
