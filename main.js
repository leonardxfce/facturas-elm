...
var $author$project$Messages$ArchivoMsg = function (a) {
	return {$: 'ArchivoMsg', a: a};
};
var $author$project$Messages$ContenidoCSVRecibido = function (a) {
	return {$: 'ContenidoCSVRecibido', a: a};
};
var $author$project$Messages$LinkClicked = function (a) {
	return {$: 'LinkClicked', a: a};
};
var $author$project$Messages$NavMsg = function (a) {
	return {$: 'NavMsg', a: a};
};
...
var $author$project$Types$Pedido = F4(
	function (id, items, estado, fechaEntrega) {
		return {estado: estado, fechaEntrega: fechaEntrega, id: id, items: items};
	});
var $elm$json$Json$Decode$andThen = _Json_andThen;
var $author$project$Types$Item = F3(
...
var $author$project$Persistence$decodeItem = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Types$Item,
	A2($elm$json$Json$Decode$field, 'productoId', $elm$json$Json$Decode$int),
	A2(
...
var $author$project$Types$Entregado = {$: 'Entregado'};
var $elm$json$Json$Decode$fail = _Json_fail;
var $author$project$Persistence$stringToEstadoDecoder = function (str) {
	switch (str) {
		case 'Borrador':
			return $elm$json$Json$Decode$succeed($author$project$Types$Borrador);
		case 'Entregado':
			return $elm$json$Json$Decode$succeed($author$project$Types$Entregado);
		default:
			return $elm$json$Json$Decode$fail('Estado desconocido: ' + str);
	}
};
var $author$project$Persistence$decodePedido = A5(
	$elm$json$Json$Decode$map4,
	$author$project$Types$Pedido,
	...
	$elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
				...
				$elm$json$Json$Decode$field,
				'items',
				$elm$json$Json$Decode$list($author$project$Persistence$decodeItem)),
	...
	$elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
				...
				$elm$json$Json$Decode$field,
				'estado',
				A2($elm$json$Json$Decode$andThen, $author$project$Persistence$stringToEstadoDecoder, $elm$json$Json$Decode$string)),
				$elm$json$Json$Decode$succeed($author$project$Types$Borrador)
			])),
		...
		function (c, p, nP, nE) {
			return function (base) {
				return _Utils_update(
					base,
					{catalogo: c, nextPedidoId: nE, nextProductoId: nP, pedidos: p});
			};
		}),
	$elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
				...
				$elm$json$Json$Decode$field,
				'catalogo',
				$elm$json$Json$Decode$list($author$project$Persistence$decodeProducto)),
				$elm$json$Json$Decode$succeed(_List_Nil)
			])),
	$elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
				...
				$elm$json$Json$Decode$field,
				'pedidos',
				$elm$json$Json$Decode$list($author$project$Persistence$decodePedido)),
				$elm$json$Json$Decode$succeed(_List_Nil)
			])),
	$elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
				A2($elm$json$Json$Decode$field, 'nextProductoId', $elm$json$Json$Decode$int),
				$elm$json$Json$Decode$succeed(1)
			])),
	$elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
				A2($elm$json$Json$Decode$field, 'nextPedidoId', $elm$json$Json$Decode$int),
				$elm$json$Json$Decode$succeed(1)
			])));
...
var $author$project$Persistence$encodeItem = function (i) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'productoId',
				$elm$json$Json$Encode$int(i.productoId)),
				_Utils_Tuple2(
				'snapshot',
				...
				_Utils_Tuple2(
				'cantidad',
				$elm$json$Json$Encode$int(i.cantidad))
			]));
};
var $author$project$Types$estadoToString = function (estado) {
	if (estado.$ === 'Borrador') {
		return 'Borrador';
	} else {
		return 'Entregado';
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'items',
				A2($elm$json$Json$Encode$list, $author$project$Persistence$encodeItem, p.items)),
				_Utils_Tuple2(
				'estado',
				$elm$json$Json$Encode$string(
					$author$project$Types$estadoToString(p.estado))),
				_Utils_Tuple2(
				'fechaEntrega',
				A2(
					$elm$core$Maybe$withDefault,
					$elm$json$Json$Encode$null,
					A2($elm$core$Maybe$map, $elm$json$Json$Encode$string, p.fechaEntrega)))
			]));
};
var $author$project$Persistence$encodeProducto = function (p) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'catalogo',
				A2($elm$json$Json$Encode$list, $author$project$Persistence$encodeProducto, model.catalogo)),
				_Utils_Tuple2(
				'pedidos',
				A2($elm$json$Json$Encode$list, $author$project$Persistence$encodePedido, model.pedidos)),
				_Utils_Tuple2(
				'nextProductoId',
				$elm$json$Json$Encode$int(model.nextProductoId)),
				_Utils_Tuple2(
				'nextPedidoId',
				$elm$json$Json$Encode$int(model.nextPedidoId))
			]));
};
var $author$project$Update$saveStorage = _Platform_outgoingPort('saveStorage', $elm$core$Basics$identity);
	...
	function (saveState, msg, model) {
		switch (msg.$) {
			...
			case 'ExportarPedidosCSV':
				...
				var encabezado = 'PedidoID,Estado,Producto,Cantidad,PrecioUnitario,Subtotal\n';
				var contenido = _Utils_ap(
					encabezado,
					A2(
						$elm$core$String$join,
						'\n',
						A2($elm$core$List$map, pedidoToCsvLines, model.pedidos)));
				return _Utils_Tuple2(
					model,
					$author$project$Ports$downloadFile(
						{content: contenido, name: 'pedidos.csv'}));
			case 'CargarProductosCSV':
				return _Utils_Tuple2(
					model,
					$author$project$Ports$selectFile(_Utils_Tuple0));
			default:
				var content = msg.a;
				...
				var _v1 = A3(
					$elm$core$List$foldl,
					procesarLinea,
					_Utils_Tuple2(model.catalogo, model.nextProductoId),
					lineas);
	...
	return _Utils_eq(pedido.estado, $author$project$Types$Entregado) ? A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('w-100 contrast'),
						$elm$html$Html$Events$onClick(
						$author$project$Messages$ArchivoMsg($author$project$Messages$ExportarAPDF))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('📄 Imprimir Pedido')
					]))
			])) : A2(
		$elm$html$Html$div,
		_List_fromArray(
			...
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('secondary'),
						$elm$html$Html$Events$onClick(
						$author$project$Messages$PedMsg($author$project$Messages$CancelarEdicionPedido))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Cancelar')
				...
				_List_fromArray(
					[
						$elm$html$Html$text('✅ Marcar como Entregado')
					])),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick(
						$author$project$Messages$PedMsg($author$project$Messages$GuardarPedido))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('💾 Guardar Cambios')
					]))
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(producto.nombre)
					])),
				A2(
				$elm$html$Html$td,
				_List_Nil,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('outline contrast'),
						$elm$html$Html$Events$onClick(
						$author$project$Messages$ArchivoMsg($author$project$Messages$ExportarAPDF)),
						A2($elm$html$Html$Attributes$attribute, 'aria-label', 'Exportar a PDF')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('📄')
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						'Pedido #' + $elm$core$String$fromInt(pedido.id))
					])),
				esSoloLectura ? A2(
				$elm$html$Html$h3,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						'Entregado: ' + A2($elm$core$Maybe$withDefault, 'N/A', pedido.fechaEntrega))
					])) : $elm$html$Html$text('')
			]));
};
...
var $author$project$Messages$CambiarCantidadItem = F2(
	function (a, b) {
		return {$: 'CambiarCantidadItem', a: a, b: b};
	});
var $author$project$Messages$PedirEliminarItem = function (a) {
	return {$: 'PedirEliminarItem', a: a};
};
var $elm$html$Html$Attributes$type_ = $elm$html$Html$Attributes$stringProperty('type');
var $author$project$View$Pedidos$Components$viewItem = F2(
	function (esSoloLectura, item) {
		return A2(
			$elm$html$Html$tr,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(item.snapshot.nombre)
						])),
					A2(
					$elm$html$Html$td,
					_List_Nil,
					_List_fromArray(
						[
							esSoloLectura ? $elm$html$Html$text(
							$elm$core$String$fromInt(item.cantidad)) : A2(
							$elm$html$Html$input,
							_List_fromArray(
								[
		...
		return A2(
			...
			_List_fromArray(
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text('Precio Unit.')
										])),
									A2(
									$elm$html$Html$th,
									_List_Nil,
					...
					A2(
						$elm$core$List$map,
						$author$project$View$Pedidos$Components$viewItem(esSoloLectura),
						items)),
					A2(
					$elm$html$Html$tfoot,
					_List_Nil,
...
var $author$project$View$Pedidos$viewEditarPedido = F3(
	function (catalogo, data, pedido) {
		...
		return A2(
			...
			_List_fromArray(
				[
					$author$project$View$Pedidos$Header$viewHeader(pedido),
					A2(
					$elm$html$Html$section,
					_List_fromArray(
						[
								...
								[
									...
									_List_fromArray(
										[
											...
											A2(
												$elm$core$List$map,
												$author$project$View$Pedidos$ProductList$viewAgregarProductoAPedido,
												A2(
													$elm$core$List$filter,
													function (p) {
														return A2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('producto-precio'),
...
var $author$project$Messages$PedirEliminarProducto = function (a) {
	return {$: 'PedirEliminarProducto', a: a};
};
var $author$project$View$Productos$Tabla$viewProducto = function (producto) {
	return A2(
		$elm$html$Html$tr,
		_List_Nil,
		_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onClick(
								$author$project$Messages$ProdMsg(
									$author$project$Messages$EditarProducto(producto.id))),
								A2($elm$html$Html$Attributes$attribute, 'aria-label', 'Editar')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('✏️')
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onClick(
								$author$project$Messages$ProdMsg(
									$author$project$Messages$PedirEliminarProducto(producto.id))),
								A2($elm$html$Html$Attributes$attribute, 'aria-label', 'Eliminar')
							]),
						_List_fromArray(
							[
...
var $author$project$View$Productos$Tabla$viewTablaProductos = function (productos) {
	return A2(
		$elm$html$Html$table,
		_List_fromArray(
			[
...
var $author$project$Messages$IrAListadoPedidos = {$: 'IrAListadoPedidos'};
var $author$project$View$Inicio$viewInicio = A2(
	$elm$html$Html$article,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Sistema de Facturas')
				])),
			A2(
			$elm$html$Html$section,
			_List_Nil,
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Events$onClick(
							$author$project$Messages$NavMsg($author$project$Messages$IrAGestionProductos))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Gestión de Productos')
				...
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('w-100'),
							$elm$html$Html$Events$onClick(
							$author$project$Messages$NavMsg($author$project$Messages$IrAListadoPedidos))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Gestión de Pedidos')
						]))
				])),
			A2(
			$elm$html$Html$section,
				...
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('outline'),
							$elm$html$Html$Events$onClick(
							$author$project$Messages$ArchivoMsg($author$project$Messages$ExportarProductosCSV))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('📦 Productos CSV')
						])),
					A2(
					$elm$html$Html$button,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('outline'),
							$elm$html$Html$Events$onClick(
							$author$project$Messages$ArchivoMsg($author$project$Messages$ExportarPedidosCSV))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('📝 Pedidos CSV')
						]))
				]))
		]));
var $author$project$Messages$AgregarPedido = {$: 'AgregarPedido'};
var $author$project$Messages$EliminarPedido = function (a) {
	return {$: 'EliminarPedido', a: a};
};
var $author$project$Messages$IrAEditarPedido = function (a) {
	return {$: 'IrAEditarPedido', a: a};
};
var $elm$html$Html$span = _VirtualDom_node('span');
var $author$project$View$Pedidos$Components$viewResumenPedido = function (pedido) {
	return A2(
		$elm$html$Html$tr,
		_List_Nil,
		_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								_Utils_eq(pedido.estado, $author$project$Types$Entregado) ? 'badge-success' : 'badge-info')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
					...
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('outline'),
								$elm$html$Html$Events$onClick(
								$author$project$Messages$NavMsg(
									$author$project$Messages$IrAEditarPedido(pedido.id))),
								A2($elm$html$Html$Attributes$attribute, 'aria-label', 'Ver/Editar')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
								_Utils_eq(pedido.estado, $author$project$Types$Entregado) ? '👁️' : '✏️')
							])),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
								...
								$author$project$Messages$PedMsg(
									$author$project$Messages$EliminarPedido(pedido.id))),
								A2($elm$html$Html$Attributes$attribute, 'aria-label', 'Eliminar')
							]),
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Messages$PedMsg($author$project$Messages$AgregarPedido))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('➕ Nuevo Pedido')
							])),
						A2(
						$elm$html$Html$section,
						_List_fromArray(
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		...
		onUrlChange: A2($elm$core$Basics$composeL, $author$project$Messages$NavMsg, $author$project$Messages$UrlChanged),
		onUrlRequest: A2($elm$core$Basics$composeL, $author$project$Messages$NavMsg, $author$project$Messages$LinkClicked),
		subscriptions: function (_v0) {
			return $author$project$Ports$fileContentReceived(
				A2($elm$core$Basics$composeL, $author$project$Messages$ArchivoMsg, $author$project$Messages$ContenidoCSVRecibido));
		},
